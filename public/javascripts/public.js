$(document).ready(function() {
	    ...
	    $(document).ready(function() {
	      $("#virtual_tour_tab").click(function() {
	          //unreveal_slide(page_content);
	          $("#virtual_tour_dialog").dialog("open");
	          return false;
	      });
	      $("#virtual_tour_dialog").dialog({
	          autoOpen: false,
	          modal: true,
	          height: 410,
	          width: 860
    ...
    getScreenSize = function() {
        ...
        pageSize = {
            w: Math.min(screenWidth, winWidth),
            h: Math.min(screenHeight, winHeight)
        };
        return pageSize;
    }
    /////////////////////////////////////////////////
